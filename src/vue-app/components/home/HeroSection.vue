<template>
	<section class="hero">
		...
		<div class="hero__decorations">
			...
			<div class="decoration decoration--heart decoration--heart-1">
				♡
			</div>
			<div class="decoration decoration--heart decoration--heart-2">
				♥
			</div>
			<div class="decoration decoration--sparkle decoration--sparkle-1">
				✨
			</div>
			<div class="decoration decoration--sparkle decoration--sparkle-2">
				⭐
			</div>
		</div>
